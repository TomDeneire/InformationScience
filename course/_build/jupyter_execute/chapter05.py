...
In these examples, the trailing `c:lvd:` number is a unique Library Object Identifier (LOI) used by our LMS [Brocade](https://en.wikipedia.org/wiki/Brocade_Library_Services)
