...
Another interesting information theory principle that was recently in the [news](https://www.newscientist.nl/nieuws/computerpoort-verbruikt-bijna-minimale-hoeveelheid-energie/) is [Landauer's Principle](https://en.wikipedia.org/wiki/Landauer%27s_principle), which has to do with the limits of energy consumption in computation.
